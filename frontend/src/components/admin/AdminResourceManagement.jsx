  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">View and manage all facilities and equipment.</p>
      </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {resources.map((resource) => (
            <article 
              ...
              className="cursor-pointer transition-all hover:-translate-y-1 hover:shadow-md hover:border-teal-200 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm shadow-slate-900/5 flex flex-col h-full"
            >
