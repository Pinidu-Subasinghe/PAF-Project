        ...
        http
            ...
            .sessionManagement(session -> session.sessionCreationPolicy(SessionCreationPolicy.IF_REQUIRED))
                .authorizeHttpRequests(auth -> auth
                    ...
                    .requestMatchers(HttpMethod.PUT, "/api/v1/tickets/*/assign", "/api/v1/tickets/*/reject").hasRole("ADMIN")
                    .requestMatchers(HttpMethod.PUT, "/api/v1/tickets/*/resolve").hasAnyRole("ADMIN", "TECHNICIAN")
                    .requestMatchers(HttpMethod.PUT, "/api/v1/tickets/*/close").hasRole("USER")
                    .requestMatchers(HttpMethod.DELETE, "/api/v1/tickets/*").hasRole("USER")
